...
struct Bin_traits<superblock_header, 0x8000> {
	static const size_t superblock_size = 0x8000;
	...
	static const size_t minimal_object_size = 2 * sizeof(void*);
	static const size_t bins_count = 13;
...
template <class superblock_header>
const size_t Bin_traits<superblock_header, 0x8000>::bins_sizes[bins_count] = { 
	minimal_object_size, 2 * minimal_object_size, 3 * minimal_object_size, 4 * minimal_object_size, 5 * minimal_object_size, 
	1 << 7, 1 << 8, 1 << 9, 1 << 10, 1 << 11, 1 << 12, 1 << 13, biggest_object_size 
};


template<class superblock_header>
size_t Bin_traits<superblock_header, 0x8000>::get_bin_index(size_t size) { 
...
template<class superblock_header>
inline size_t Bin_traits<superblock_header, 0x8000>::get_bin_size(size_t index) {
...
inline size_t Bin_traits<Header, 0x8000>::get_real_size(size_t size) {
